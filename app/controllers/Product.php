...
class Product extends Controller{
    ...
    public function list() {
        ...
        $productOnePage = 12; // Số bài viết hiển thị trong 1 trang.
        ...
        $data['sub_content']['list_categories'] = $this->prodCateModel->findByField([]);

        // Load

        $data['content'] = 'clients.products.list_new';
        ...
        $data['data_js'] = [
            'product'     => 'clients.products.js_list'
        ];
    ...
    public function detail($id) {
        ...
        $data['content'] = 'clients.products.detail_new';
        ...
        $data['data_js'] = [
            'product_detail'    => 'clients.products.js_detail_new',
            'product'           => 'clients.products.js_list'
        ];
